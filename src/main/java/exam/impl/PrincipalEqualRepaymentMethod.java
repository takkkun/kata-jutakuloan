...
public class PrincipalEqualRepaymentMethod implements RepaymentMethod {
    ...
    public PrincipalEqualRepaymentMethod(final BigDecimal amountOfMoneyBorrowed, final Integer numberOfRepayments, final Integer times) {
